...
export default function HomePage() {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Solutions électriques complètes pour résidences et entreprises. Matériel de qualité et services
            d'installation experts.
          </p>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              { icon: Zap, title: "Installation", desc: "Installations électriques professionnelles" },
              { icon: Truck, title: "Livraison", desc: "Livraison rapide partout au Cameroun" },
              { icon: Shield, title: "Garantie", desc: "Garantie complète sur tous les produits" },
              { icon: Wrench, title: "Support", desc: "Support technique 24/7 disponible" },
            ].map((service, idx) => {
      ...
      <section className="py-16 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-12 text-center">Catégories</h2>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-amber-500 to-orange-600">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Besoin d'une installation?</h2>
          <p className="text-white/90 mb-8 text-lg">
            Nos experts sont prêts à vous aider. Devis gratuit et sans engagement.
          </p>
