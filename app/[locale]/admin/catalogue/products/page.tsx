  ...
  return (
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight">{t("title", { defaultMessage: "Products" })}</h2>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>{t("fields.category", { defaultMessage: "Category" })}</TableHead>
              <TableHead>{t("fields.brand", { defaultMessage: "Brand" })}</TableHead>
              <TableHead className="text-right">{t("fields.price", { defaultMessage: "Price" })}</TableHead>
                ...
                <TableRow key={product.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <Button variant="ghost" size="icon" onClick={() => alert('Edit modals coming soon!')}>
